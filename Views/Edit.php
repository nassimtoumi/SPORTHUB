					...
					<form action="ModifierUtilisateur.php" method="POST">
						...
						<ul class="form-cover">
							<li class="inp-name">
								...
								<input  disabled type="text" name="Username" placeholder="<?php echo $_SESSION['name'] ?>" required>
							</li>
							<li class="inp-email">
								<label>Email </label>
								<input type="text" name="Email"required pattern=".+@.+" placeholder="<?php echo $_SESSION['email'] ?>" >
							</li>
							<li class="inp-email">
